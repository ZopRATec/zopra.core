...
class MultiList(ForeignList):
    ...
    def initDBName(self):
        ...
        if self.map:
            ...
            self.dbname = "%smulti%s%s" % (mgr.getId(), self.table, self.listname)
    ...
    def createTable(self):
        ...
        table_dict = {
            "tableid": {ZC.COL_TYPE: ZC.ZCOL_INT},
    ...
    def getMLRef(self, tableid=None, listid=None):
        ...
        if tableid:
            ...
            return []
        query = "Select %s from %s where %s = %s" % (id2name, self.dbname, id1name, id1)
    ...
    def updateMLNotes(self, tableid, listid, notes):
        ...
        query = query % (self.dbname, notes, tableid, self.listname, listid)
    ...
    def getMLNotes(self, tableid, listid):
        ...
        query = query % (self.dbname, tableid, self.listname, listid)
